  ...
  return (
    ...
    {hasToken && (
      <div className="footer">
        <div className="footer__item -blue">
          <span className="footer__icon">
            ...
            <div className="footer__item -orange">
                <span className="footer__icon">
                    <svg className="icon">
            ...
            <div className="footer__item -navy-blue">
                <span className="footer__icon">
                    <svg className="icon">
            ...
            <div className="footer__item -yellow">
                <span className="footer__icon">
                    <svg className="icon">
            ...
            <div className="footer__item -purple">
                <span className="footer__icon">
                    <svg className="icon">
